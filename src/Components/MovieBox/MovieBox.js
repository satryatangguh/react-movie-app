    ...
    return (
        <>
            <div className="card h-100 text-center bg-dark rounded-3">
                <img className="card-img-top h-100" src={API_IMG + poster_path} alt={title || name} />
                <div className="card-body text-light">
                    ...
                    <Modal size="md" variant="dark" show={show} onHide={handleClose}>
                        ...
                        <div className='modal-body'>
                            <img className="card-img-top rounded-2" style={{ height: "100%" }} src={API_IMG + backdrop_path} alt={title || name} />
